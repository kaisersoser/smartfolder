...
const DARK: Palette = Palette {
    ...
    border_subtle: Color32::from_rgba_premultiplied(20, 20, 20, 20),
    border: Color32::from_rgba_premultiplied(34, 34, 34, 34),
    border_strong: Color32::from_rgba_premultiplied(58, 58, 58, 58),
    success: Color32::from_rgb(97, 211, 148),
    success_bg: Color32::from_rgba_premultiplied(12, 26, 19, 32),
    warning: Color32::from_rgb(241, 189, 90),
    warning_bg: Color32::from_rgba_premultiplied(32, 25, 12, 34),
    info: Color32::from_rgb(122, 167, 255),
    info_bg: Color32::from_rgba_premultiplied(16, 22, 34, 34),
    error: Color32::from_rgb(255, 107, 107),
    error_bg: Color32::from_rgba_premultiplied(34, 14, 14, 34),
};
